...
> Операторы связи и DPI активно блокируют VPN-трафик. Применяют белые списки - cidr фильтрацию.

WDTT прокладывает WireGuard-туннель **внутри** DTLS-соединения через TURN-серверы VK. Таким образом для оператора и DPI ваш трафик неотличим от обычного видеозвонка — тот же протокол, те же ip адресса, те же порты.
